  ...
  const services = [
    {
      ...
      description:
        "Design strategy is the plan behind a design that ensures every creative decision aligns with the brand's goals and users' needs.",
      tags: [
        "Brand Purpose",
        "Target Audience",
        "Business Goals",
    ...
    },
    {
      ...
      title: "UI/UX Design",
      description:
        "UI/UX design focuses on creating intuitive, user-centered digital experiences that are functional, visually engaging, and easy to use.",
      tags: [
        "User Research",
        "Wireframing",
        "Prototyping",
    ...
    },
    {
      ...
      description:
        "Building strong visual identity systems including logos, color palettes, typography, and brand guidelines for market standing.",
      tags: [
        "Logo Design",
        "Typography",
        "Color Palette",
    ...
    },
    {
      ...
      description:
        "Developing high-performance, responsive web applications with seamless animations and clean, scalable code architectures.",
      tags: [
        "React JS",
        "Next.js",
        "Tailwind CSS",

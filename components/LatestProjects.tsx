...
const projects = [
  {
    id: 1,
    title: "Cumin Co.",
    description: "Packaging design and brand identity for a spice & condiments brand",
  ...
  },
  {
    id: 2,
    title: "Vamshi Farms",
    description: "Label design and dieline development for a farm-to-table produce line",
  ...
  },
  {
    id: 3,
    title: "Loam",
    description: "Complete visual identity and packaging system for a skincare brand",
  ...
  },
  {
    ...
    description: "Packaging concept and print-ready design for a pet food brand",
